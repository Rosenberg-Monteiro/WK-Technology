...
CREATE TABLE `pedidosprodutos` (
  ...
  KEY `PedidosProduto` (`CodigoProduto`)
...
INSERT INTO `pedidosprodutos` VALUES (1,1,2,2.00,1500.00,3000.00),(5,1,1,2.00,120.00,240.00),(6,1,1,3.00,115.00,345.00),(8,2,1,10.00,115.28,1152.80),(9,2,2,20.00,121.00,2420.00);
...
-- Dump completed on 2022-06-10 23:52:15
